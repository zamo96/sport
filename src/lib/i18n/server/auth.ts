...
export const serverAuthMessages = defineServerMessages(
  {
    ...
    "auth.error.agreementRequired": "Accept the current user agreement",
    "auth.error.smsUnavailable": "Could not send the SMS. Try again later or sign in with VK ID.",
    "auth.error.russiaPhoneOnly": "In Russia, sign in with a phone number or VK ID.",
    "auth.error.invalidPhoneCode": "The code is wrong or has expired. Request a new SMS.",
  ...
  },
  {
    ...
    "auth.error.agreementRequired": "Примите актуальное пользовательское соглашение",
    "auth.error.smsUnavailable": "Не удалось отправить SMS. Попробуйте позже или войдите через VK ID.",
    "auth.error.russiaPhoneOnly": "В России вход — по номеру телефона или через VK ID.",
    "auth.error.invalidPhoneCode": "Неверный или просроченный код. Запросите новое SMS.",
