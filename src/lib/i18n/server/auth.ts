...
export const serverAuthMessages = defineServerMessages(
  {
    ...
    "auth.error.rateLimited": "Too many sign-in attempts. Please try again in 10 minutes.",
  ...
  },
  {
    ...
    "auth.error.rateLimited": "Слишком много попыток входа. Повторите через 10 минут.",
