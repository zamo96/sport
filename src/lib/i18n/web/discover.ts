...
export const discoverMessages = defineWebMessages(
  {
    ...
    "discover.swipe.emptyText": "Change the sport filters or come back when new players join.",
  ...
  },
  {
    ...
    "discover.swipe.emptyText": "Измени спорт в фильтрах или вернись позже, когда появятся новые игроки.",
