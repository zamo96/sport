...
def new_doc(title):
    ...
    header=s.header.paragraphs[0];header.text='SportSearch  |  Комплект документов  |  Проект 07.09.2026'
    ...
    d.core_properties.subject='Бесплатное приложение SportSearch без рекламы'
    d.core_properties.author='SportSearch'
    d.core_properties.keywords='Проект; персональные данные; самозанятый; SportSearch'
    d.core_properties.created=datetime(2026,9,7,0,0,tzinfo=timezone.utc)
    d.core_properties.modified=datetime(2026,9,7,0,0,tzinfo=timezone.utc)
